...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
        if ( 'save' == $_REQUEST['action'] ) {
            ...
            header("Location: admin.php?page=setting.php&saved=true");
            die;
        }
    }
 ...
 <tr>
   ...
   <tr>
        ...
        <td>
            ...
            订阅号：<input class="d_inp_short" name="d_weixin" id="d_weixin" type="text" value="<?php echo dopt('d_weixin'); ?>"><span class="d_tip">微信图片直接替换主题同名weixin.jpg即可。</span>
        </td>
    </tr>
   <tr>
